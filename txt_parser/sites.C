...
//void sites::print_map_qt(QTextBrowser *textbrowser)
//{
//    bool eol;
//    QTextCursor prev_cursor = textbrowser->textCursor();
//    for(int i=0;i<vert_tiles;i++)
//        for(int j=0;j<horz_tiles;j++)
//        {
//            if(j==horz_tiles-1)
//            {
//                eol = true;
//                textbrowser->insertPlainText(QString::fromStdString(_tile[j][i].x));
//            }
//            else if(eol == true)
//            {
//                textbrowser->append(QString::fromStdString(_tile[j][i].x));
//                eol = false;
//            }
//            else
//                textbrowser->insertPlainText(QString::fromStdString(_tile[j][i].x));
